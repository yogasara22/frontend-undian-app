    ...
    <div className="w-full flex justify-center relative z-20 px-2 lg:px-0">
      ...
      <div className="relative w-full max-w-[360px] md:max-w-[420px] bg-[#0f54a8] p-2 md:p-3 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.6)] border-[2px] border-[#09356d] rounded-[16px] md:rounded-[24px] overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full bg-[#fca311] p-1 rounded-[14px] md:rounded-[20px] shadow-[inset_0_-2px_6px_rgba(0,0,0,0.1),0_4px_10px_rgba(0,0,0,0.4)] border border-[#e89000]/50 outline outline-1 outline-offset-[-1px] outline-[#fca311]">
          ...
          <div className="w-full h-full bg-white flex flex-col items-center justify-center p-2 md:p-3 shadow-[inset_0_1px_6px_rgba(0,0,0,0.05)] rounded-[12px] md:rounded-[16px] min-h-[70px] md:min-h-[100px]">
